...
- **Program wrap staged:** 48 h timer (fires ~20:35Z 07-11) checks c15 with the 12 h+-wall guard; when it walls, bank the floor, compile the 6-basin characteristic-floor distribution as the program result, and decide next: opt_4 revisit (right-censored floor) / 6th seed / M1-campaign-10 reassignment / parallel basins on Vast (§3).
